...
class TitleBar
{
  ...
  public final boolean onLifeCycleEvent(Activity activity, Object component, ActivityController.Interceptor.InterceptorEvent event)
  {
    if (component == null && event == ActivityController.Interceptor.InterceptorEvent.onSuperCreateBefore && !(activity instanceof TitleBar.TitleBarDiscarded))
    {
    ...
    else if (component == null && event == ActivityController.Interceptor.InterceptorEvent.onContentChanged && !(activity instanceof TitleBarDiscarded))
    {
      if (activity instanceof Smarted<?>)
      {
        final Smarted<TitleBarAggregate> smartedActivity = (Smarted<TitleBarAggregate>) activity;
    ...
    else if (component == null && event == ActivityController.Interceptor.InterceptorEvent.onResume && !(activity instanceof TitleBar.TitleBarDiscarded))
    {
